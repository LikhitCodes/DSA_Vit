# Student Roll Number Assignment Based on Marks using BST

## Name: Likhit Chirmade, Roll no: 23

## Theory

### Binary Search Tree for Ranking

BST organized by marks where higher marks appear on right subtree, lower on left.

**Key Concept:** Reverse inorder traversal (right-root-left) visits nodes in descending order of marks.

### Algorithm

**Insert:**
```
1. If marks < root.marks → Insert left
2. Else → Insert right
```

**Assign Roll Numbers:**
```
1. Traverse right subtree (higher marks)
2. Assign roll number to current node
3. Increment roll counter
4. Traverse left subtree (lower marks)
```
...
Reverse Inorder: Bob(92) → Alice(85) → Carol(78)
Roll Numbers: Bob=1, Alice=2, Carol=3
```
